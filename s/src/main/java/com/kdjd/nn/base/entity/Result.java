package com.kdjd.nn.base.entity;
...
public class Result<T> {
	...
	public class Header {
		...
		public Header(String errorCode, String message, boolean success, Integer status) {
			super();
			this.errorCode = errorCode;
			this.message = message;
			this.success = success;
		...
		public String toString() {
			return "Header [errorCode=" + errorCode + ", message=" + message + ", success=" + success + ", status="
					+ status + "]";
		}
